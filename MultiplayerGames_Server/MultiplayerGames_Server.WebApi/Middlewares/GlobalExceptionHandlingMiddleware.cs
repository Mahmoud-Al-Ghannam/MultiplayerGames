...
using AppUnauthorizedAccessException = MultiplayerGames_Server.Application.Common.Exceptions.UnauthorizedAccessException;

namespace MultiplayerGames_Server.WebApi.Middlewares;
